...
public class MainMenuPageScript : MonoBehaviour
{
    ...
    public void GoToMiniGame()
    {
        ...
        StartCoroutine(SceneAsynchronousLoad("MiniGameScene"));
    ...
    void Awake()
    {
        slideImage.GetComponent<Animator>().StopPlayback();
    }

    IEnumerator LoadSlideImage()
    {
        while (true)
        {
            ...
            slideImage.GetComponent<Animator>().SetTrigger("slideimagetrigger");
